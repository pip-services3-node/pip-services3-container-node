...
class ComponentConfig {
    ...
    static fromConfig(config) {
        var descriptor = pip_services3_commons_node_1.Descriptor.fromString(config.getAsNullableString("descriptor"));
        var type = pip_services3_commons_node_2.TypeDescriptor.fromString(config.getAsNullableString("type"));
